...
const Hero = () => {
  ...
  useEffect(() => {
    ...
    // Mouse tracking for cursor-aware elements
  ...
  return (
    ...
    >
      ...
      <div 
        className="w-full py-12 relative z-10 transition-all duration-1000 ease-out"
        style={{
          opacity: heroOpacity,
        }}
      >
        ...
        <div className="container-max section-padding">
          <div className="grid lg:grid-cols-2 gap-12 items-center mb-12">
            ...
            <div className="text-center lg:text-left">
              <div className="space-y-6 mb-8">
                <h1 
                  ref={nameRef}
                  className={`text-5xl md:text-6xl lg:text-7xl font-bold leading-tight tracking-tight transition-all duration-1000 ease-out ${
                ...
                <h2 
                  className={`text-xl md:text-2xl lg:text-3xl font-medium transition-all duration-1000 ease-out delay-300 ${
                    isLoaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'
                  }`}
                >
                ...
                <p 
                  className={`text-lg md:text-xl text-gray-600 dark:text-gray-300 leading-relaxed transition-all duration-1000 ease-out delay-500 ${
                    isLoaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'
                  }`}
                >
              ...
              {/* Social Links */}
              <div className={`flex justify-center lg:justify-start space-x-6 transition-all duration-1000 ease-out delay-900 ${
                isLoaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'
              }`}>
                <a
                  ...
                  className="text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-200 transition-all duration-200 p-3 hover:bg-white/30 dark:hover:bg-gray-800/30 rounded-lg hover:scale-110 backdrop-blur-sm"
                >
                  <Github size={24} />
                </a>
                <a
          ...
          <div className="text-center">
            <button
              ...
              className={`text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-200 transition-all duration-1000 ease-out delay-1100 animate-bounce ${
                isLoaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'
              }`}
            >
              <ArrowDown size={24} />
